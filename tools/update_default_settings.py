...
def main():
    ...
    arm_settings = (
            ...
            ("apt_source_deb", '"deb http://packages.lingmo.com/lingmo camel main contrib non-free"'),
            ("apt_source_deb_src", '"#deb-src http://packages.lingmo.com/lingmo camel main contrib non-free"'),
