...
ControlPlatformFrame::ControlPlatformFrame(QWidget* parent)
    ...
    , m_subTitleLbl(new CommentLabel(tr("Set the region for Lingmo EndPoint Management Platform")))
...
bool ControlPlatformFrame::event(QEvent* event)
{
    if (event->type() == QEvent::LanguageChange) {
        ...
        m_subTitleLbl->setText(tr("Set the region for Lingmo EndPoint Management Platform"));
    }
